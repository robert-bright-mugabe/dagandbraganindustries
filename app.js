...
const products = [
  {
    ...
    price: 18000,
    image: "./images/liquid-detergent.jpg", // <-- Update path to match your folder structure
    stock: 15
  },
  {
    ...
    price: 12000,
    image: "./images/toilet-bowl-cleaner.jpg", // <-- Update path to match your folder structure
    stock: 20
  },
  {
    ...
    price: 15000,
    image: "./images/disinfectant-spray.jpg", // <-- Update path to match your folder structure
    stock: 10
  }
];
